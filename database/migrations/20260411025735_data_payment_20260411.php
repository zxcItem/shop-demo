...
class DataPayment20260411 extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $this->_create_data_payment_address();
        $this->_create_data_payment_balance();
        $this->_create_data_payment_config();
        $this->_create_data_payment_integral();
        $this->_create_data_payment_record();
        $this->_create_data_payment_refund();
    }

    /**
     * 创建数据对象
     * @class DataPaymentAddress
     * @table data_payment_address
     */
    private function _create_data_payment_address()
    {
        // 创建数据表对象
        $table = $this->table('data_payment_address', [
            'engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '支付-地址',
        ]);
        // 创建或更新数据表
     ...
     * @table data_payment_balance
     */
    private function _create_data_payment_balance()
    {
        // 创建数据表对象
        $table = $this->table('data_payment_balance', [
            'engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '支付-余额',
        ]);
        // 创建或更新数据表
        PhinxExtend::upgrade($table, [
     ...
     * @table data_payment_config
     */
    private function _create_data_payment_config()
    {
        // 创建数据表对象
        $table = $this->table('data_payment_config', [
            'engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '支付-配置',
        ]);
        // 创建或更新数据表
        PhinxExtend::upgrade($table, [
     ...
     * @table data_payment_integral
     */
    private function _create_data_payment_integral()
    {
        // 创建数据表对象
        $table = $this->table('data_payment_integral', [
            'engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '支付-积分',
        ]);
        // 创建或更新数据表
        PhinxExtend::upgrade($table, [
            ['unid', 'biginteger', ['limit' => 20, 'default' => 0, 'null' => true, 'comment' => '账号编号']],
     ...
     * @table data_payment_record
     */
    private function _create_data_payment_record()
    {
        // 创建数据表对象
        $table = $this->table('data_payment_record', [
            'engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '支付-行为',
        ]);
        // 创建或更新数据表
        PhinxExtend::upgrade($table, [
    ...
    /**
     * 创建数据对象
     * @class DataPaymentRefund
     * @table data_payment_refund
     */
    private function _create_data_payment_refund()
    {
        // 创建数据表对象
        $table = $this->table('data_payment_refund', [
            'engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '支付-退款',
        ]);
        // 创建或更新数据表
        PhinxExtend::upgrade($table, [
            ['unid', 'biginteger', ['limit' => 20, 'default' => 0, 'null' => true, 'comment' => '主账号编号']],
