...
class DataWemall20260411 extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $this->_create_data_wemall_config_agent();
        $this->_create_data_wemall_config_coupon();
        $this->_create_data_wemall_config_discount();
        $this->_create_data_wemall_config_level();
        $this->_create_data_wemall_config_notify();
        $this->_create_data_wemall_config_poster();
        $this->_create_data_wemall_config_rebate();
        $this->_create_data_wemall_express_company();
        $this->_create_data_wemall_express_template();
        $this->_create_data_wemall_goods();
        $this->_create_data_wemall_goods_cate();
        $this->_create_data_wemall_goods_item();
        $this->_create_data_wemall_goods_mark();
        $this->_create_data_wemall_goods_stock();
        $this->_create_data_wemall_help_feedback();
        $this->_create_data_wemall_help_problem();
        $this->_create_data_wemall_help_question();
        $this->_create_data_wemall_help_question_x();
        $this->_create_data_wemall_order();
        $this->_create_data_wemall_order_cart();
        $this->_create_data_wemall_order_item();
        $this->_create_data_wemall_order_refund();
        $this->_create_data_wemall_order_sender();
        $this->_create_data_wemall_user_action_collect();
        $this->_create_data_wemall_user_action_comment();
        $this->_create_data_wemall_user_action_history();
        $this->_create_data_wemall_user_action_search();
        $this->_create_data_wemall_user_checkin();
        $this->_create_data_wemall_user_coupon();
        $this->_create_data_wemall_user_create();
        $this->_create_data_wemall_user_rebate();
        $this->_create_data_wemall_user_recharge();
        $this->_create_data_wemall_user_relation();
        $this->_create_data_wemall_user_transfer();
    }

    /**
     * 创建数据对象
     * @class dataWemallConfigAgent
     * @table data_wemall_config_agent
     */
    private function _create_data_wemall_config_agent()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_config_agent', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallConfigCoupon
     * @table data_wemall_config_coupon
     */
    private function _create_data_wemall_config_coupon()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_config_coupon', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallConfigDiscount
     * @table data_wemall_config_discount
     */
    private function _create_data_wemall_config_discount()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_config_discount', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallConfigLevel
     * @table data_wemall_config_level
     */
    private function _create_data_wemall_config_level()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_config_level', [
            'engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '商城-配置-等级',
        ]);
        // 创建或更新数据表
        PhinxExtend::upgrade($table, [
     ...
     * @table data_wemall_config_notify
     */
    private function _create_data_wemall_config_notify()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_config_notify', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallConfigPoster
     * @table data_wemall_config_poster
     */
    private function _create_data_wemall_config_poster()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_config_poster', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallConfigRebate
     * @table data_wemall_config_rebate
     */
    private function _create_data_wemall_config_rebate()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_config_rebate', [
     ...
     * @table data_wemall_express_company
     */
    private function _create_data_wemall_express_company()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_express_company', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallExpressTemplate
     * @table data_wemall_express_template
     */
    private function _create_data_wemall_express_template()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_express_template', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallGoods
     * @table data_wemall_goods
     */
    private function _create_data_wemall_goods()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_goods', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallGoodsCate
     * @table data_wemall_goods_cate
     */
    private function _create_data_wemall_goods_cate()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_goods_cate', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallGoodsItem
     * @table data_wemall_goods_item
     */
    private function _create_data_wemall_goods_item()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_goods_item', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallGoodsMark
     * @table data_wemall_goods_mark
     */
    private function _create_data_wemall_goods_mark()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_goods_mark', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallGoodsStock
     * @table data_wemall_goods_stock
     */
    private function _create_data_wemall_goods_stock()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_goods_stock', [
     ...
     * @table data_wemall_help_feedback
     */
    private function _create_data_wemall_help_feedback()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_help_feedback', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallHelpProblem
     * @table data_wemall_help_problem
     */
    private function _create_data_wemall_help_problem()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_help_problem', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallHelpQuestion
     * @table data_wemall_help_question
     */
    private function _create_data_wemall_help_question()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_help_question', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallHelpQuestionX
     * @table data_wemall_help_question_x
     */
    private function _create_data_wemall_help_question_x()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_help_question_x', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallOrder
     * @table data_wemall_order
     */
    private function _create_data_wemall_order()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_order', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallOrderCart
     * @table data_wemall_order_cart
     */
    private function _create_data_wemall_order_cart()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_order_cart', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallOrderItem
     * @table data_wemall_order_item
     */
    private function _create_data_wemall_order_item()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_order_item', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallOrderRefund
     * @table data_wemall_order_refund
     */
    private function _create_data_wemall_order_refund()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_order_refund', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallOrderSend
     * @table data_wemall_order_send
     */
    private function _create_data_wemall_order_send()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_order_send', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallOrderSender
     * @table data_wemall_order_sender
     */
    private function _create_data_wemall_order_sender()
    {
        // 数据表重命名
        if ($this->hasTable('data_wemall_order_send') && !$this->hasTable('data_wemall_order_sender')) {
            $this->table('data_wemall_order_send')->rename('data_wemall_order_sender');
        }

        // 创建数据表对象
        $table = $this->table('data_wemall_order_sender', [
            'engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '商城-订单-配送',
        ]);
        // 创建或更新数据表
        PhinxExtend::upgrade($table, [
     ...
     * @table data_wemall_user_action_collect
     */
    private function _create_data_wemall_user_action_collect()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_user_action_collect', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallUserActionComment
     * @table data_wemall_user_action_comment
     */
    private function _create_data_wemall_user_action_comment()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_user_action_comment', [
     ...
     * @table data_wemall_user_action_history
     */
    private function _create_data_wemall_user_action_history()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_user_action_history', [
     ...
     * @table data_wemall_user_action_search
     */
    private function _create_data_wemall_user_action_search()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_user_action_search', [
     ...
     * @table data_wemall_user_checkin
     */
    private function _create_data_wemall_user_checkin()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_user_checkin', [
     ...
     * @table data_wemall_user_coupon
     */
    private function _create_data_wemall_user_coupon()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_user_coupon', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallUserCreate
     * @table data_wemall_user_create
     */
    private function _create_data_wemall_user_create()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_user_create', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallUserRebate
     * @table data_wemall_user_rebate
     */
    private function _create_data_wemall_user_rebate()
    {
        // 创建数据表对象
    ...
    /**
     * 创建数据对象
     * @class dataWemallUserRecharge
     * @table data_wemall_user_recharge
     */
    private function _create_data_wemall_user_recharge()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_user_recharge', [
     ...
     * @table data_wemall_user_relation
     */
    private function _create_data_wemall_user_relation()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_user_relation', [
    ...
    /**
     * 创建数据对象
     * @class dataWemallUserTransfer
     * @table data_wemall_user_transfer
     */
    private function _create_data_wemall_user_transfer()
    {
        // 创建数据表对象
        $table = $this->table('data_wemall_user_transfer', [
