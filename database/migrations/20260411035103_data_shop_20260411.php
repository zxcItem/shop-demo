...
class DataShop20260411 extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $this->_create_data_shop_config_agent();
        $this->_create_data_shop_config_coupon();
        $this->_create_data_shop_config_discount();
        $this->_create_data_shop_config_level();
        $this->_create_data_shop_config_notify();
        $this->_create_data_shop_config_poster();
        $this->_create_data_shop_config_rebate();
        $this->_create_data_shop_express_company();
        $this->_create_data_shop_express_template();
        $this->_create_data_shop_goods();
        $this->_create_data_shop_goods_cate();
        $this->_create_data_shop_goods_item();
        $this->_create_data_shop_goods_mark();
        $this->_create_data_shop_goods_stock();
        $this->_create_data_shop_help_feedback();
        $this->_create_data_shop_help_problem();
        $this->_create_data_shop_help_question();
        $this->_create_data_shop_help_question_x();
        $this->_create_data_shop_order();
        $this->_create_data_shop_order_cart();
        $this->_create_data_shop_order_item();
        $this->_create_data_shop_order_refund();
        $this->_create_data_shop_order_sender();
        $this->_create_data_shop_user_action_collect();
        $this->_create_data_shop_user_action_comment();
        $this->_create_data_shop_user_action_history();
        $this->_create_data_shop_user_action_search();
        $this->_create_data_shop_user_checkin();
        $this->_create_data_shop_user_coupon();
        $this->_create_data_shop_user_create();
        $this->_create_data_shop_user_rebate();
        $this->_create_data_shop_user_recharge();
        $this->_create_data_shop_user_relation();
        $this->_create_data_shop_user_transfer();
    }

    /**
     * 创建数据对象
     * @class dataShopConfigAgent
     * @table data_shop_config_agent
     */
    private function _create_data_shop_config_agent()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_config_agent', [
    ...
    /**
     * 创建数据对象
     * @class dataShopConfigCoupon
     * @table data_shop_config_coupon
     */
    private function _create_data_shop_config_coupon()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_config_coupon', [
    ...
    /**
     * 创建数据对象
     * @class dataShopConfigDiscount
     * @table data_shop_config_discount
     */
    private function _create_data_shop_config_discount()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_config_discount', [
    ...
    /**
     * 创建数据对象
     * @class dataShopConfigLevel
     * @table data_shop_config_level
     */
    private function _create_data_shop_config_level()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_config_level', [
            'engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '商城-配置-等级',
        ]);
        // 创建或更新数据表
        PhinxExtend::upgrade($table, [
    ...
    /**
     * 创建数据对象
     * @class dataShopConfigNotify
     * @table data_shop_config_notify
     */
    private function _create_data_shop_config_notify()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_config_notify', [
     ...
     * @table data_shop_config_poster
     */
    private function _create_data_shop_config_poster()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_config_poster', [
    ...
    /**
     * 创建数据对象
     * @class dataShopConfigRebate
     * @table data_shop_config_rebate
     */
    private function _create_data_shop_config_rebate()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_config_rebate', [
    ...
    /**
     * 创建数据对象
     * @class dataShopExpressCompany
     * @table data_shop_express_company
     */
    private function _create_data_shop_express_company()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_express_company', [
    ...
    /**
     * 创建数据对象
     * @class dataShopExpressTemplate
     * @table data_shop_express_template
     */
    private function _create_data_shop_express_template()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_express_template', [
     ...
     * 创建数据对象
     * @class dataShopGoods
     * @table data_shop_goods
     */
    private function _create_data_shop_goods()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_goods', [
    ...
    /**
     * 创建数据对象
     * @class dataShopGoodsCate
     * @table data_shop_goods_cate
     */
    private function _create_data_shop_goods_cate()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_goods_cate', [
    ...
    /**
     * 创建数据对象
     * @class dataShopGoodsItem
     * @table data_shop_goods_item
     */
    private function _create_data_shop_goods_item()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_goods_item', [
     ...
     * @table data_shop_goods_mark
     */
    private function _create_data_shop_goods_mark()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_goods_mark', [
     ...
     * @table data_shop_goods_stock
     */
    private function _create_data_shop_goods_stock()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_goods_stock', [
    ...
    /**
     * 创建数据对象
     * @class dataShopHelpFeedback
     * @table data_shop_help_feedback
     */
    private function _create_data_shop_help_feedback()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_help_feedback', [
     ...
     * @table data_shop_help_problem
     */
    private function _create_data_shop_help_problem()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_help_problem', [
    ...
    /**
     * 创建数据对象
     * @class dataShopHelpQuestion
     * @table data_shop_help_question
     */
    private function _create_data_shop_help_question()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_help_question', [
    ...
    /**
     * 创建数据对象
     * @class dataShopHelpQuestionX
     * @table data_shop_help_question_x
     */
    private function _create_data_shop_help_question_x()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_help_question_x', [
     ...
     * 创建数据对象
     * @class dataShopOrder
     * @table data_shop_order
     */
    private function _create_data_shop_order()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_order', [
    ...
    /**
     * 创建数据对象
     * @class dataShopOrderCart
     * @table data_shop_order_cart
     */
    private function _create_data_shop_order_cart()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_order_cart', [
    ...
    /**
     * 创建数据对象
     * @class dataShopOrderItem
     * @table data_shop_order_item
     */
    private function _create_data_shop_order_item()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_order_item', [
    ...
    /**
     * 创建数据对象
     * @class dataShopOrderRefund
     * @table data_shop_order_refund
     */
    private function _create_data_shop_order_refund()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_order_refund', [
     ...
     */
    private function _create_data_shop_order_sender()
    {
        // 数据表重命名
        if ($this->hasTable('data_shop_order_send') && !$this->hasTable('data_shop_order_sender')) {
            $this->table('data_shop_order_send')->rename('data_shop_order_sender');
        }

        // 创建数据表对象
        $table = $this->table('data_shop_order_sender', [
            'engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '商城-订单-配送',
        ]);
        // 创建或更新数据表
        PhinxExtend::upgrade($table, [
     ...
     * @table data_shop_user_action_collect
     */
    private function _create_data_shop_user_action_collect()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_user_action_collect', [
     ...
     * @table data_shop_user_action_comment
     */
    private function _create_data_shop_user_action_comment()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_user_action_comment', [
     ...
     * @table data_shop_user_action_history
     */
    private function _create_data_shop_user_action_history()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_user_action_history', [
    ...
    /**
     * 创建数据对象
     * @class dataShopUserActionSearch
     * @table data_shop_user_action_search
     */
    private function _create_data_shop_user_action_search()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_user_action_search', [
    ...
    /**
     * 创建数据对象
     * @class dataShopUserCheckin
     * @table data_shop_user_checkin
     */
    private function _create_data_shop_user_checkin()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_user_checkin', [
    ...
    /**
     * 创建数据对象
     * @class dataShopUserCoupon
     * @table data_shop_user_coupon
     */
    private function _create_data_shop_user_coupon()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_user_coupon', [
     ...
     * @table data_shop_user_create
     */
    private function _create_data_shop_user_create()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_user_create', [
     ...
     * @table data_shop_user_rebate
     */
    private function _create_data_shop_user_rebate()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_user_rebate', [
     ...
     * @table data_shop_user_recharge
     */
    private function _create_data_shop_user_recharge()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_user_recharge', [
    ...
    /**
     * 创建数据对象
     * @class dataShopUserRelation
     * @table data_shop_user_relation
     */
    private function _create_data_shop_user_relation()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_user_relation', [
    ...
    /**
     * 创建数据对象
     * @class dataShopUserTransfer
     * @table data_shop_user_transfer
     */
    private function _create_data_shop_user_transfer()
    {
        // 创建数据表对象
        $table = $this->table('data_shop_user_transfer', [
