 ...
 * @property DataAccountUser $from
 * @property DataPaymentRecord $payment
 * @property DataPaymentRecord[] $payments
 * @property DataWemallOrderItem[] $items
 * @property DataWemallOrderSender $address
 * @property DataWemallOrderSender $sender
 * @property mixed $payment_allows
 * @class DataWemallOrder
 */
class DataWemallOrder extends AbsUser
{
    /**
     * 关联推荐用户.
     */
    ...
    {
        return $this->hasMany(DataWemallOrderItem::class, 'order_no', 'order_no');
    }
    ...
    {
        return $this->hasOne(DataPaymentRecord::class, 'order_no', 'order_no')->where([
            'payment_status' => 1,
        ]);
    }
    ...
    {
        return $this->hasMany(DataPaymentRecord::class, 'order_no', 'order_no')->order('id desc')->withoutField('payment_notify');
    }
    ...
    {
        return $this->hasOne(DataWemallOrderSender::class, 'order_no', 'order_no');
    }
