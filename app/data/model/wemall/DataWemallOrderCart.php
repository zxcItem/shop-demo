...
/**
 * Class plugin\wemall\model\DataWemallOrderCart.
 *
 * @property int $id
 ...
 * @property DataWemallGoodsItem $specs
 */
class DataWemallOrderCart extends AbsUser
{
    /**
     * 关联产品数据.
     */
    ...
    {
        return $this->hasOne(DataWemallGoodsItem::class, 'ghash', 'ghash');
    }
}
