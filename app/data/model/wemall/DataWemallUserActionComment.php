 ...
 * @property DataWemallGoods $bind_goods
 * @property DataWemallGoods $goods
 * @property DataWemallOrder $orderinfo
 * @class DataWemallUserActionComment
 */
class DataWemallUserActionComment extends AbsUser
{
    /**
     * 关联商品信息.
     */
    ...
    {
        return $this->hasOne(DataWemallOrder::class, 'order_no', 'order_no');
    }
