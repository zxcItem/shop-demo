 ...
 * @property DataShopConfigCoupon $bind_coupon
 * @property DataShopConfigCoupon $coupon
 * @class DataShopUserCoupon
 */
class DataShopUserCoupon extends AbsUser
{
    /**
     * 关联卡券.
     */
    ...
    {
        return $this->hasOne(DataShopConfigCoupon::class, 'id', 'coid');
    }
    ...
    public function toArray(): array
    {
        $data = parent::toArray();
        if (isset($data['type'])) {
            $data['type_name'] = DataShopConfigCoupon::types[$data['type']] ?? $data['type'];
        }
        return $data;
    }
}
