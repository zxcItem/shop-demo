 ...
 * @property DataShopUserRelation $agent1
 * @property DataShopUserRelation $agent2
 * @class DataShopUserRelation
 */
class DataShopUserRelation extends AbsUser
{
    /**
     * 关联上1级用户.
     */
    ...
    {
        return $this->hasOne(DataShopUserRelation::class, 'unid', 'puid1');
    }
    ...
    {
        return $this->hasOne(DataShopUserRelation::class, 'unid', 'puid2');
    }
     ...
     */
    public static function withInit(int $unid): DataShopUserRelation
    {
