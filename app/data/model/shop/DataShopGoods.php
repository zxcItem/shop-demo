 ...
 * @property DataShopConfigDiscount $discount
 * @property DataShopGoodsItem[] $items
 * @property DataShopUserActionComment[] $comments
 * @class DataShopGoods
 */
class DataShopGoods extends Abs
{
    /**
     * 日志名称.
     * @var string
    ...
    {
        return $this->hasMany(DataShopGoodsItem::class, 'gcode', 'code')
    ...
    {
        return $this->hasMany(DataShopUserActionComment::class, 'gcode', 'code')->with('bindUser');
    }
    ...
    {
        return $this->hasOne(DataShopConfigDiscount::class, 'id', 'discount_id')->where(['status' => 1, 'deleted' => 0])->field('id,name,items');
    }
    ...
    {
        $ckey = 'PluginShopGoodsMarkItems';
        $items = sysvar($ckey) ?: sysvar($ckey, DataShopGoodsMark::items());
    ...
    {
        $ckey = 'PluginShopGoodsCateItem';
        $cates = sysvar($ckey) ?: sysvar($ckey, DataShopGoodsCate::items(true));
