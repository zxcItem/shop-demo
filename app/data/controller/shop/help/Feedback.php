...
namespace app\data\controller\shop\help;

use app\data\model\account\DataAccountUser;
use app\data\model\shop\DataShopHelpFeedback;
use app\data\model\shop\DataShopHelpProblem;
...
class Feedback extends Controller
{
    ...
    public function index()
    {
        ...
        DataShopHelpFeedback::mQuery()->layTable(function () {
            $this->title = '意见反馈管理';
    ...
    {
        $this->title = '编辑意见反馈';
        DataShopHelpFeedback::mForm('form');
    }
    ...
    {
        DataShopHelpFeedback::mSave($this->_vali([
    ...
    public function sync()
    {
        ...
        if (($feedback = DataShopHelpFeedback::mk()->findOrEmpty($input['id']))->isExists()) {
            try {
                $problem = DataShopHelpProblem::mk()->where(['fid' => $input['id']])->findOrEmpty();
