...
use app\data\model\shop\DataShopConfigPoster;
use app\data\service\shop\PosterService;
...
class Poster extends Controller
{
    ...
    public function index()
    {
        ...
        DataShopConfigPoster::mQuery()->layTable(function () {
            $this->title = '推广海报管理';
    ...
    {
        $this->title = '添加推广海报';
        DataShopConfigPoster::mForm('form');
    }
    ...
    {
        DataShopConfigPoster::mSave($this->_vali([
