...
use app\data\model\shop\DataShopConfigNotify;
...
class Notify extends Controller
{
    ...
    public function index()
    {
        ...
        DataShopConfigNotify::mQuery()->layTable(function () {
            $this->title = '系统通知管理';
    ...
    {
        $this->title = '添加系统通知';
        DataShopConfigNotify::mForm('form');
    }
    ...
    {
        DataShopConfigNotify::mSave($this->_vali([
