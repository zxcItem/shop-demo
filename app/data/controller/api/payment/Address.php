...
class Address extends Auth
{
    ...
    public function set()
    {
        ...
        if (empty($data['id'])) {
            ...
            if (DataPaymentAddress::mk()->where($map)->count() >= 10) {
                $this->error('最多10个地址！');
            }
        }
    ...
    {
        $model = DataPaymentAddress::mk()->withoutField('deleted');
     ...
     */
    private function withDefault(int $id = 0, int $type = 1, bool $force = false): DataPaymentAddress
    {
