...
class Coupon extends Auth
{
    ...
    public function get()
    {
        DataWemallConfigCoupon::mQuery(null, function (QueryHelper $query) {
    ...
    {
        DataWemallUserCoupon::mQuery(null, function (QueryHelper $query) {
    ...
    public function query()
    {
        ...
        DataWemallConfigCoupon::mQuery(null, function (QueryHelper $query) use ($data, $gcodes) {
            ...
            if (!empty($data['usable'])) {
                $db = DataWemallUserCoupon::mk()->where(['unid' => $this->unid, 'status' => 1, 'deleted' => 0]);
    ...
    protected function _get_page_filter(array &$data)
    {
        ...
        $query = DataWemallUserCoupon::mk()->field(['count(1)' => 'c', 'coid' => 'd']);
