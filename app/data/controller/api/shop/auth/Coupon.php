...
class Coupon extends Auth
{
    ...
    public function get()
    {
        DataShopConfigCoupon::mQuery(null, function (QueryHelper $query) {
    ...
    {
        DataShopUserCoupon::mQuery(null, function (QueryHelper $query) {
    ...
    public function query()
    {
        ...
        DataShopConfigCoupon::mQuery(null, function (QueryHelper $query) use ($data, $gcodes) {
            ...
            if (!empty($data['usable'])) {
                $db = DataShopUserCoupon::mk()->where(['unid' => $this->unid, 'status' => 1, 'deleted' => 0]);
    ...
    protected function _get_page_filter(array &$data)
    {
        ...
        $query = DataShopUserCoupon::mk()->field(['count(1)' => 'c', 'coid' => 'd']);
