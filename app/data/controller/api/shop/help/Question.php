...
namespace app\data\controller\api\shop\help;
...
class Question extends Auth
{
    ...
    public function get()
    {
        DataShopHelpQuestion::mQuery(null, function (QueryHelper $query) {
            if (input('id', 0) > 0) {
                $query->with(['comments']);
            }
    ...
    public function set()
    {
        ...
        if (($model = DataShopHelpQuestion::mk())->save($data)) {
    ...
    public function reply()
    {
        ...
        if (DataShopHelpQuestionX::mk()->save($data)) {
            $this->success('提交成功！');
        } else {
            $this->error('提交失败！');
        }
    ...
    public function confirm()
    {
        ...
        $question = DataShopHelpQuestion::mk()->findOrEmpty($data['ccid']);
