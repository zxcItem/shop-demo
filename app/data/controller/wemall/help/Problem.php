...
class Problem extends Controller
{
    ...
    public function index()
    {
        ...
        DataWemallHelpProblem::mQuery($this->get)->layTable(function () {
            $this->title = '常见问题管理';
    ...
    {
        $this->title = '添加常见问题';
        DataWemallHelpProblem::mForm('form');
    }
    ...
    {
        DataWemallHelpProblem::mSave($this->_vali([
