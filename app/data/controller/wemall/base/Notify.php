...
use app\data\model\wemall\DataWemallConfigNotify;
...
class Notify extends Controller
{
    ...
    public function index()
    {
        ...
        DataWemallConfigNotify::mQuery()->layTable(function () {
            $this->title = '系统通知管理';
    ...
    {
        $this->title = '添加系统通知';
        DataWemallConfigNotify::mForm('form');
    }
    ...
    {
        DataWemallConfigNotify::mSave($this->_vali([
    ...
    {
        DataWemallConfigNotify::mDelete();
    }
