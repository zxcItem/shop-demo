...
use app\data\service\wemall\UserCreate;
...
class Create extends Controller
{
    ...
    public function index()
    {
        ...
        DataWemallUserCreate::mQuery()->layTable(function () {
            $this->title = '会员用户管理';
    ...
    public function add()
    {
        DataWemallUserCreate::mForm('form');
    }
    ...
    protected function _form_filter(array &$data)
    {
        ...
        if ($this->request->isPost()) {
            ...
            if (!empty($data['agent_phone'])) {
                ...
                $relation = DataWemallUserRelation::mk()->where(['unid' => $user->getAttr('id')])->findOrEmpty();
                if ($relation->isEmpty()) {
                    $this->error('无效推荐人');
                }
